...
for config in route_cfg:
    ...
    route_name = config
    route = Route(route_name=route_name, urls=urls, methods=methods, type=type, trigger_field=trigger_field, required_fields=required_fields)
    routes.append(route)